...
console.log(`Total Element in the array is:${arrayNum.length}`);
...
console.log(`========Traversing values from array=======`);
...
console.log(array);
console.log(`===== Removing the every first element   =====`);
...
const removed1 =arrayNu.splice(3,1);//remove 44 only
